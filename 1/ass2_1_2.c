    ...
    if(process_1 =fork() == 0){
        ...
        if(pid2 = fork() == 0){
            ...
            if(process_3 = fork() == 0){
                ...
                printf("Time taken by process 1: %f", (time_3_sec - time_initial_sec + (time_3_nsec - time_initial_nsec)/1e9));
                printf("\nTime taken by process 2: %f", (time_3_sec - time_1_sec + (time_3_nsec - time_1_nsec)/1e9));
                printf("\nTime taken by process 3: %f",  (time_3_sec - time_2_sec + (time_3_nsec - time_2_nsec)/1e9));
